...
🛠️ Заключение и выводы (Lessons Learned)Избыточное логирование: Уровень DEBUG3 производит слишком много информации. Рекомендуется перевести LogLevel в режим INFO.Контроль учетных записей: Учетная запись sophia была скомпрометирована брутфорсом. Необходимо внедрить политику сложных паролей.