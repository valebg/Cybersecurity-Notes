...
3. Собирает массив сырых данных, разбивает их и конвертирует ASCII-коды (`chr(int(num))`) в финальное текстовое полотно.
...
*Нажмите на изображен# Blue Team Labs / CTF Challenge: Barcode World 
...
for i in range(1, 9375):
	...
	if image is None:
		...
		for barcode in decoded:
			...
			print("[-] Ошибка конвертации:", e)
ие выше, чтобы проверить статус выполнения на платформе Blue Team Labs.
